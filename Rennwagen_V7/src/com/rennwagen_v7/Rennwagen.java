...
public class Rennwagen
{
	...
	private ArrayList<Fahrer> meinefahrer = new ArrayList();
	...
	public Rennwagen()
	{
		//this.id = Rennwagen.anzahlrennwagen;
	...
	public void druckeFahrerliste()
	{
		...
		for (Fahrer element : this.meinefahrer)
		{
			element.getInfo();
			System.out.println(); // wegen der Lesbarkeit
		}
	}
