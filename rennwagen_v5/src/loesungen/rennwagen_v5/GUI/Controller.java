...
import loesungen.rennwagen_v5.logik.RennwagenController;
...
public class Controller implements Initializable{
    ...
    @FXML
    private ListView<Fahrer> fahrerlistview;

    private ObservableList<Rennwagen> rennwagenliste = FXCollections.observableArrayList();
    private ObservableList<Fahrer> fahrerliste = FXCollections.observableArrayList();
    ...
    @FXML
    private void handleBtnHinzufuegenAction(ActionEvent actionEvent) throws ClassNotFoundException, SQLException{
        RennwagenController rennwagenController = new RennwagenController();
        Rennwagen rennwagen = new Rennwagen();
        this.getDetails(rennwagen);
        this.rennwagenliste.add(rennwagen);
        rennwagenController.insert(rennwagen);
        listview.refresh();
    }

    @FXML
    public void handleBtnAendernAction(ActionEvent actionEvent) throws ClassNotFoundException, SQLException{
